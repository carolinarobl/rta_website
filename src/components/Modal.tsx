import { type Signal, component$, Slot, type QwikMouseEvent } from "@builder.io/qwik";
  ...
  ({ showSignal }: { showSignal: Signal<boolean> }) => {
    return (
      <div
        ...
        id="modalback"
        onClick$={(e: QwikMouseEvent<HTMLDivElement, MouseEvent>) => {
          const targetElement = e.target as HTMLDivElement;
          if (targetElement.id === "modalback") {
