...
export const GigfastCloud = component$(({ data }: { data: any }) => {
    ...
    return <div class="flex flex-col items-center justify-center">
        <StrapiImage url={dataPage['GNetworkLogo']['data']['attributes']['formats']['small']['url']} alt={dataPage['GNetworkLogo']['data']['attributes']['alternativeText']} title={dataPage['GNetworkLogo']['data']['attributes']['caption']}
