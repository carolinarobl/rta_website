...
export const SectionHeaderZSS = component$(({ data }: { data: any }) => {
  ...
  const LateralBox1 = component$(({ data }: { data: any }) => {
    return (
      <div class="flex max-w-[400px] flex-col items-center max-[900px]:place-self-center">
        ...
        <div class="flex h-[380px] w-full flex-col items-center justify-center rounded-xl px-4 transition-all max-[900px]:mt-8  ">
          <div
            onClick$={() => {
  ...
  const MidBox = component$(({ data }: { data: any }) => {
    return (
        ...
        >
          ...
          <div class="flex max-w-[400px] flex-col items-center max-[900px]:place-self-center">
            ...
            <a
              ...
              class="my-8 w-full rounded-full border-[6px] border-[#e7758f] bg-secondary-red px-8 py-1 text-center text-[14px] font-[600] leading-[18px] text-white shadow-lg"
            >
