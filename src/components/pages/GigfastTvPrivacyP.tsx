...
export const GigfastTvPrivacyP = component$(({ data }: { data: any }) => {
  return <div class="px-4 py-2 md:px-10 md:py-2">
    ...
    <Markdown text={data['TextContent']} classN="markdownTitle markdownh3 markdownHyper tracking-wider text-primary-blue font-normal text-sm md:text-base"></Markdown>
  </div>
});