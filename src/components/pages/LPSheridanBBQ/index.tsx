...
import { SectionHeader } from "../LPSheridanBBQ/SectionHeader";
import { SectionSpeed } from "../LPFreeInstall/SectionSpeed";
import { SectionRating } from "../LPSheridanBBQ/SectionRating";


export const LPSheridan = component$(({ data }: { data: any }) => {

  const logoData = data['Logo']['data']['attributes'];
  const sectionHeadData = data['SectionHead'];

  const speedList = data['Bullets'];
