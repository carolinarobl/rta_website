      ...
      <div class="flex min-h-[200px]  w-full items-center justify-center bg-gradient-to-br from-primary-light-blue to-[#23477f] p-8">
        <div class="flex w-full max-w-[1200px] flex-col items-center justify-center">
          <span class="text-center text-[38px] font-[600] leading-10 text-white max-[800px]:text-[28px]">
            ...
            {isSpanish ? "Encuentra ofertas disponibles en tu área":"Find available offers in your area"}

          </span>
          <div class="mt-8 flex w-full items-center justify-center gap-8 max-[1200px]:flex-col">
            {/* <div class="flex min-h-[360px] items-center justify-center overflow-hidden rounded-2xl min-[1200px]:w-[30%]">
              <iframe
                src={
