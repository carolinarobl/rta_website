...
export const PortabilityIntro = component$(({ data }: { data: any }) => {
  const logoSrc = data["Logo"]["data"]["attributes"];
  const mediaSrc = data["Media"]["data"]["attributes"];
  return (
    <div class="flex max-w-[1200px] items-center justify-center self-center max-[800px]:flex-col">
      <div class="flex flex-col items-center justify-center gap-4 px-10 min-[800px]:w-[70%]">
        ...
        <div class="max-w-[470px]">
          <StrapiImage url={logoSrc['url']}  alt={logoSrc['alternativeText']} title={logoSrc['caption']} width={1230} height={230} />
        </div>
        <div>
          <Markdown
      ...
      <div class="flex w-[300px] items-center justify-center self-center p-4 min-[800px]:w-[30%]">
        <StrapiImage url={mediaSrc['url']} alt={mediaSrc['alternativeText']} title={mediaSrc['caption']} width={1000} height={1000} />
      </div>
    </div>
  );
});
