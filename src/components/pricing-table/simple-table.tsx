...
export const SimpleTable = component$(() => {
    return (
        <div class="justify-between items-center shadow-lg bg-white flex flex-col px-5 rounded-[35px]">
            ...
            <div class="justify-center items-center self-center shadow bg-white flex w-[306px] max-w-full flex-col mt-80 mb-8 px-5 py-1.5 rounded-[100px] border-2 border-solid border-teal-500 border-opacity-60 max-md:mt-10">
