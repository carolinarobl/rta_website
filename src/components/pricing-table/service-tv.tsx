      ...
      <div class="items-center self-center flex w-[310px] max-w-full flex-col mt-8">
        <div class="items-start self-center flex w-full gap-5">
          <StrapiImage
            ...
            height={80}
            media={logo}
            clasN="aspect-square object-contain object-center w-[70px] justify-center items-center overflow-hidden self-stretch max-w-full"
          />
          ...
          <div class="justify-center items-start self-stretch flex gap-2.5 mt-2.5">
            {channels.map((channel: any, index: any) => (
              <StrapiImage
                ...
                clasN="aspect-square object-contain object-center w-full overflow-hidden flex-1"
              />
            ))}
          </div>
        </div>
