...
import {BsChatSquareTextFill, BsUpload, BsPersonFill, BsGeoAltFill, BsEnvelopeAtFill,
  ...
  <form class='mt-2'>
      <div class='flex flex-wrap items-center'>
          ...
          <div class="w-2/3 sm:w-1/3 mb-4">
              ...
              <div class="flex items-center p-2 rounded">
                  ...
                  <input type="tel" id="zip-code" class="w-full border border-color-Primary p-2 rounded-xl focus:outline-none focus:border-blue-500" maxLength={5} required />
              </div>
          </div>
      </div>
      <div class='flex flex-wrap items-center justify-around'>
          <div class="mb-4 w-full sm:w-1/2 ">
              ...
              <div class="flex items-center p-2 rounded">
                  ...
                  <input type="email" id="email" class="w-full border border-color-Primary p-2 rounded-xl focus:outline-none focus:border-blue-500" required />
              </div>
          </div>
      ...
      <div class="mb-4">
          ...
          <div class="flex items-center p-2 rounded">
              ...
              <textarea id="message" class="w-full border border-color-Primary p-2 rounded-xl focus:outline-none focus:border-blue-500" rows={4} required></textarea>
          </div>
      </div>
