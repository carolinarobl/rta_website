...
export default component$(() => {
    ...
    <MainLayout data={data['layoutData']}>
        <AppreciationGiveaway data={data['pageData']['data']['pageAprGive']['data']['attributes']}></AppreciationGiveaway>
    </MainLayout>
    </>
});
...
export const head: DocumentHead =({resolveValue})=>{
    ...
    const seoData = pageData['pageData']['data']['pageAprGive']['data']['attributes']['SEO']
